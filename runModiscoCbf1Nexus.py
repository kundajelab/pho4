...
all_post_counts_hypimps = np.load('data/imp-scores/cbf1_nexus/post_counts_hypimps.npy')
all_post_profile_hypimps = np.load('data/imp-scores/cbf1_nexus/post_profile_hypimps.npy') 
all_post_counts_actualimps = np.load('data/imp-scores/cbf1_nexus/post_counts_actualimps.npy') 
all_post_profile_actualimps = np.load('data/imp-scores/cbf1_nexus/post_profile_actualimps.npy') 
all_labels_profile = np.load('data/imp-scores/cbf1_nexus/labels_profile.npy') 
all_labels_logcount = np.load('data/imp-scores/cbf1_nexus/labels_logcount.npy') 
all_preds_profile = np.load('data/imp-scores/cbf1_nexus/preds_profile.npy') 
all_preds_logcount = np.load('data/imp-scores/cbf1_nexus/preds_logcount.npy')
all_seqs = np.load('data/imp-scores/cbf1_nexus/seqs.npy') 
...
counts_tfmodisco_results = modisco.tfmodisco_workflow.workflow.TfModiscoWorkflow(
    ...
    one_hot=all_seqs)
counts_grp = h5py.File("data/modisco/cbf1_nexus/counts_results.hdf5")
...
profile_tfmodisco_results = modisco.tfmodisco_workflow.workflow.TfModiscoWorkflow(
    ...
    one_hot=all_seqs)
profile_grp = h5py.File("data/modisco/cbf1_nexus/profile_results.hdf5")
