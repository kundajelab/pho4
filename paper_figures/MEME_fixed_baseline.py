# meme 100_around_summits.fa -dna -revcomp -w 30 -o meme_out_fixed
...
PHO4_PBEXO_PSPM = fileToPSPM("../data/pho4_pbexo/meme_out_fixed/PSPM.txt", "PHO4_PBEXO_PSPM_fixed")
CBF1_PBEXO_PSPM = fileToPSPM("../data/cbf1_pbexo/meme_out_fixed/PSPM.txt", "CBF1_PBEXO_PSPM_fixed")
PHO4_NEXUS_PSPM = fileToPSPM("../data/nexus/120min/meme_out_fixed/PSPM.txt", "PHO4_NEXUS_PSPM_fixed")
CBF1_NEXUS_PSPM = fileToPSPM("../data/cbf1_nexus/meme_out_fixed/PSPM.txt", "CBF1_NEXUS_PSPM_fixed")
...
keyToPWM = {}
keyToPWM["pho4_pbexo"] = probToPWM(PHO4_PBEXO_PSPM, "PHO4_PBEXO_PWM_fixed")
keyToPWM["cbf1_pbexo"] = probToPWM(CBF1_PBEXO_PSPM, "CBF1_PBEXO_PWM_fixed")
keyToPWM["pho4_nexus"] = probToPWM(PHO4_NEXUS_PSPM, "PHO4_NEXUS_PWM_fixed")
keyToPWM["cbf1_nexus"] = probToPWM(CBF1_NEXUS_PSPM, "CBF1_NEXUS_PWM_fixed")
...
for key in keyToPWM:
    ...
    # ax.set_ylim((1,5.75))
    # ax.set_aspect('equal')
    fig.savefig(key+'_MEME_fixed_baseline.png', dpi=300)
    plt.clf()
    with open(key+'_MEME_fixed_metadata.json', 'w') as fp: json.dump(meta, fp)