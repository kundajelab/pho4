...
model_path = "/users/amr1/pho4/data/models/big_cbf1_pbexo_model.h5"
bed_path = "/users/amr1/pho4/data/cbf1_pbexo/1000_around_summits.bed.gz"
...
targets_coordstovals = coordstovals.bigwig.PosAndNegSeparateLogCounts(
    pos_strand_bigwig_path="/users/amr1/pho4/data/cbf1_pbexo/basename_prefix.pooled.positive.bigwig",
    neg_strand_bigwig_path="/users/amr1/pho4/data/cbf1_pbexo/basename_prefix.pooled.negative.bigwig",
...
np.save('data/imp-scores/cbf1_pbexo_big/post_counts_hypimps.npy', test_post_counts_hypimps)
np.save('data/imp-scores/cbf1_pbexo_big/post_profile_hypimps.npy', test_post_profile_hypimps) 
np.save('data/imp-scores/cbf1_pbexo_big/post_counts_actualimps.npy', test_post_counts_actualimps) 
np.save('data/imp-scores/cbf1_pbexo_big/post_profile_actualimps.npy', test_post_profile_actualimps) 
np.save('data/imp-scores/cbf1_pbexo_big/labels_profile.npy', test_labels_profile) 
np.save('data/imp-scores/cbf1_pbexo_big/labels_logcount.npy', test_labels_logcount) 
np.save('data/imp-scores/cbf1_pbexo_big/preds_profile.npy', test_preds_profile) 
np.save('data/imp-scores/cbf1_pbexo_big/biastrack_profile.npy', test_biastrack_profile) 
np.save('data/imp-scores/cbf1_pbexo_big/biastrack_logcount.npy', test_biastrack_logcount) 
np.save('data/imp-scores/cbf1_pbexo_big/preds_logcount.npy', test_preds_logcount) 
np.save('data/imp-scores/cbf1_pbexo_big/seqs.npy', test_seqs) 
np.save('data/imp-scores/cbf1_pbexo_big/coords.npy', test_coords) 