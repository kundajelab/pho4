# Processing AR R3 SELEX-seq data
...
workDir = "/users/amr1/pho4/SelexGLM/processing/AR_R3"
...
selex.defineSample('AR_R3',
                   paste(processedDataDir, "/ar_selex/r3/SRR5340730.1_1.fastq", sep = ""),
                   'AR_R3',
                   3, 23, '', 'TGGAA')
...
dataSample = selex.sample(seqName = 'AR_R3', sampleName = 'AR_R3', round = 3)
