# Processing AR R8 SELEX-seq data
...
workDir = "/users/amr1/pho4/SelexGLM/processing/AR_R8"
...
selex.defineSample('AR_R8',
                   paste(processedDataDir, "/ar_selex/r8/SRR5340725.1_1.fastq", sep = ""),
                   'AR_R8',
                   8, 23, '', 'TGGAA')
...
dataSample = selex.sample(seqName = 'AR_R8', sampleName = 'AR_R8', round = 8)
