# Processing GR R8 SELEX-seq data
...
workDir = "/users/amr1/pho4/SelexGLM/processing/GR_R8"
...
selex.defineSample('GR_R8',
                   paste(processedDataDir, "/gr_selex/r8/SRR5340716.1_1.fastq", sep = ""),
                   'GR_R8',
                   8, 23, '', 'TGGAA')
...
dataSample = selex.sample(seqName = 'GR_R8', sampleName = 'GR_R8', round = 8)
