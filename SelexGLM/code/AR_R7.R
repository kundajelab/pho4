# Processing AR R7 SELEX-seq data
...
workDir = "/users/amr1/pho4/SelexGLM/processing/AR_R7"
...
selex.defineSample('AR_R7',
                   paste(processedDataDir, "/ar_selex/r7/SRR5340726.1_1.fastq", sep = ""),
                   'AR_R7',
                   7, 23, '', 'TGGAA')
...
dataSample = selex.sample(seqName = 'AR_R7', sampleName = 'AR_R7', round = 7)
