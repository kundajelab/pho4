# Processing AR R6 SELEX-seq data
...
workDir = "/users/amr1/pho4/SelexGLM/processing/AR_R6"
...
selex.defineSample('AR_R6',
                   paste(processedDataDir, "/ar_selex/r6/SRR5340727.1_1.fastq", sep = ""),
                   'AR_R6',
                   6, 23, '', 'TGGAA')
...
dataSample = selex.sample(seqName = 'AR_R6', sampleName = 'AR_R6', round = 6)
