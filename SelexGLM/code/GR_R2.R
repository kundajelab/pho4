# Processing GR R2 SELEX-seq data
...
workDir = "/users/amr1/pho4/SelexGLM/processing/GR_R2"
...
selex.defineSample('GR_R2',
                   paste(processedDataDir, "/gr_selex/r2/SRR5340722.1_1.fastq", sep = ""),
                   'GR_R2',
                   2, 23, '', 'TGGAA')
...
dataSample = selex.sample(seqName = 'GR_R2', sampleName = 'GR_R2', round = 2)
