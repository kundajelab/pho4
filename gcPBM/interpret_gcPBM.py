...
model_path = "/users/amr1/pho4/data/models/"+target+"_model.h5"
bed_path = "/users/amr1/pho4/data/gcpbm/"+target+"/1k_around_summits.bed.gz"
...
if not os.path.exists('imp-scores/'+target):
    os.makedirs('imp-scores/'+target)
np.save('imp-scores/'+target+'/post_counts_hypimps.npy', test_post_counts_hypimps)
np.save('imp-scores/'+target+'/post_profile_hypimps.npy', test_post_profile_hypimps) 
np.save('imp-scores/'+target+'/post_counts_actualimps.npy', test_post_counts_actualimps) 
np.save('imp-scores/'+target+'/post_profile_actualimps.npy', test_post_profile_actualimps) 
np.save('imp-scores/'+target+'/labels_profile.npy', test_labels_profile) 
np.save('imp-scores/'+target+'/labels_logcount.npy', test_labels_logcount) 
np.save('imp-scores/'+target+'/preds_profile.npy', test_preds_profile) 
np.save('imp-scores/'+target+'/biastrack_profile.npy', test_biastrack_profile) 
np.save('imp-scores/'+target+'/biastrack_logcount.npy', test_biastrack_logcount) 
np.save('imp-scores/'+target+'/preds_logcount.npy', test_preds_logcount) 
np.save('imp-scores/'+target+'/seqs.npy', test_seqs) 
np.save('imp-scores/'+target+'/coords.npy', test_coords) 