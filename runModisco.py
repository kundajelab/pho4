...
for task_id, task in enumerate(task_names):
    tfname = task
    grad_wrt = task
    counts_attributions = all_post_counts_actualimps[task_id]
    counts_hyp_attributions = all_post_counts_hypimps[task_id]
    ...
    profile_attributions = all_post_profile_actualimps[task_id]
    profile_hyp_attributions = all_post_profile_hypimps[task_id]
