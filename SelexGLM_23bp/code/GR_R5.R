# Processing GR R5 SELEX-seq data
...
workDir = "/users/amr1/pho4/SelexGLM/processing/GR_R5"
...
selex.defineSample('GR_R5',
                   paste(processedDataDir, "/gr_selex/r5/SRR5340719.1_1.fastq", sep = ""),
                   'GR_R5',
                   5, 23, '', 'TGGAA')
...
dataSample = selex.sample(seqName = 'GR_R5', sampleName = 'GR_R5', round = 5)
