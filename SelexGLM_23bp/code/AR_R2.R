# Processing AR R2 SELEX-seq data
...
workDir = "/users/amr1/pho4/SelexGLM/processing/AR_R2"
...
selex.defineSample('AR_R2',
                   paste(processedDataDir, "/ar_selex/r2/SRR5340731.1_1.fastq", sep = ""),
                   'AR_R2',
                   2, 23, '', 'TGGAA')
...
dataSample = selex.sample(seqName = 'AR_R2', sampleName = 'AR_R2', round = 2)
