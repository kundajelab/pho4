# Processing GR R6 SELEX-seq data
...
workDir = "/users/amr1/pho4/SelexGLM/processing/GR_R6"
...
selex.defineSample('GR_R6',
                   paste(processedDataDir, "/gr_selex/r6/SRR5340718.1_1.fastq", sep = ""),
                   'GR_R6',
                   6, 23, '', 'TGGAA')
...
dataSample = selex.sample(seqName = 'GR_R6', sampleName = 'GR_R6', round = 6)
