# Processing GR R7 SELEX-seq data
...
workDir = "/users/amr1/pho4/SelexGLM/processing/GR_R7"
...
selex.defineSample('GR_R7',
                   paste(processedDataDir, "/gr_selex/r7/SRR5340717.1_1.fastq", sep = ""),
                   'GR_R7',
                   7, 23, '', 'TGGAA')
...
dataSample = selex.sample(seqName = 'GR_R7', sampleName = 'GR_R7', round = 7)
