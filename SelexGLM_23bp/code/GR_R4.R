# Processing GR R4 SELEX-seq data
...
workDir = "/users/amr1/pho4/SelexGLM/processing/GR_R4"
...
selex.defineSample('GR_R4',
                   paste(processedDataDir, "/gr_selex/r4/SRR5340720.1_1.fastq", sep = ""),
                   'GR_R4',
                   4, 23, '', 'TGGAA')
...
dataSample = selex.sample(seqName = 'GR_R4', sampleName = 'GR_R4', round = 4)
