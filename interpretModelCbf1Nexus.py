...
with CustomObjectScope({'MultichannelMultinomialNLL': MultichannelMultinomialNLL,'RevCompConv1D': RevCompConv1D}):
    model = load_model("/users/amr1/pho4/data/models/nexus_cbf1_model.h5")
...
targets_coordstovals = coordstovals.bigwig.PosAndNegSeparateLogCounts(
    pos_strand_bigwig_path="/users/amr1/pho4/data/cbf1_nexus/pos.bw",
    neg_strand_bigwig_path="/users/amr1/pho4/data/cbf1_nexus/neg.bw",
...
keras_test_batch_generator = coordbased.core.KerasBatchGenerator(
  coordsbatch_producer=coordbatchproducers.SimpleCoordsBatchProducer(
            bed_file="/users/amr1/pho4/data/cbf1_nexus/overlap.peaks.bed.gz",
            batch_size=64,
...
np.save('data/imp-scores/cbf1_nexus/post_counts_hypimps.npy', test_post_counts_hypimps)
np.save('data/imp-scores/cbf1_nexus/post_profile_hypimps.npy', test_post_profile_hypimps) 
np.save('data/imp-scores/cbf1_nexus/post_counts_actualimps.npy', test_post_counts_actualimps) 
np.save('data/imp-scores/cbf1_nexus/post_profile_actualimps.npy', test_post_profile_actualimps) 
np.save('data/imp-scores/cbf1_nexus/labels_profile.npy', test_labels_profile) 
np.save('data/imp-scores/cbf1_nexus/labels_logcount.npy', test_labels_logcount) 
np.save('data/imp-scores/cbf1_nexus/preds_profile.npy', test_preds_profile)
np.save('data/imp-scores/cbf1_nexus/preds_logcount.npy', test_preds_logcount) 
np.save('data/imp-scores/cbf1_nexus/seqs.npy', test_seqs) 